Write all models to the models/ folder. Also, write a vector of model descriptions to the models/ folder.

The "D2" suffix following the model names indicates that these models were designed for dataset 2, where it clear (based on empirical one-generation population maps) that the effective cannibalism rate increases with initial population density. This is not evident in the subset of data (i.e., data with no population crashes) that we use to fit the sub-models, for both dataset 1 and 3. See the file write_submodels_D1.Rmd in the scripts/ folder. 
...
mod1_description <- "demographic stochasticity (oviposition), sex-ratio stochasticity"
    ...
    for(m in 0:M)
  {
    ...
    return(log(h/3) + log_sum_exp(lp));
      ...
      ',
        ...
        here("models/mod1_D2.stan"))
```

# Model 2
model with demographic stochasticity, demographic heterogeneity, and sex-ratio stochasticity
```{r}

mod2_description <- "demographic stochasticity (oviposition), sex-ratio stochasticity, and demographic heterogeneity (oviposition)"
...
```{r}
mod4_description <- "demographic stochasticity (oviposition and cannibalism), sex-ratio stochasticity"
...
mod5_description <- "demographic stochasticity (oviposition), and demographic heterogeneity (oviposition)"
...
mod6_description <- "demographic stochasticity (oviposition)"
...
mod7_description <- "demographic heterogeneity (oviposition)"
...
mod8_description <- "demographic heterogeneity (oviposition), sex-ratio stochasticity"
...
mod9_description <- "demographic stochasticity (oviposition), sex-ratio stochasticity, and environmental stochasticity (oviposition)"
    ...
    for(m in 0:M)
  {
    ...
    return(log(h/3) + log_sum_exp(lp));
      ...
      ',
        ...
        here("models/mod9_D2.stan"))
```

# Model 10
Env stochasticity and sex ratio stoch
```{r}

mod10_description <- "environmental stochasticity (oviposition), sex-ratio stochasticity"
...
mod11_description <- "environmental stochasticity (oviposition)"
...
write('
      ...
      ',
        ...
        here("models/mod11_D2.stan"))
```


# Save model descriptions
```{r}
description_vec <- c(mod1_description, mod2_description, mod3_description, mod4_description, mod5_description, mod6_description, mod7_description, mod8_description, mod9_description, mod10_description, mod11_description)

saveRDS(description_vec, file = here("models/description_vec.rds"))
